...
/*
The nested function can reach the variable 'interval' because the nested function exists within myFunction, and thus, within it's scope.
*/
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(data){
    const newArray = data.reduce(function(previous, item){return previous + item['population']},0)
    return newArray
  }
...
const cuboidTwo = new CuboidMakerTwo(1,1,1)
